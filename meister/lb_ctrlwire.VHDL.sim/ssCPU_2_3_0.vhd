...
architecture RTL of ssCPU_2_3_0 is
  ...
  signal unused_119 : std_logic_vector(135 downto 0);
...
begin
  ...
  UF_GPR : fhm_registerfile_w32
    port map (
      ...
      w_sel0 => ua_preg32_dout, 
      w_sel1 => ua_preg26_dout, 
      data_in0 => ua_preg35_dout, 
      data_in1 => ua_preg23_dout, 
  ...
  UF_FWUL0 : fhm_fwu_lock_w32
    port map (
      ...
      data3 => ua_mux30_dout, 
      data4 => unused_99, 
      data5 => ua_preg46_dout, 
      data6 => concat_01, 
      data7 => ua_preg50_dout, 
      data8 => ua_preg23_dout, 
      num0 => ua_mux39_dout, 
      num1 => ua_mux40_dout, 
      num2 => unused_100, 
      num3 => ua_preg54_dout, 
      ...
      num7 => ua_preg61_dout, 
      num8 => ua_preg26_dout, 
      locknum1 => ua_preg21_dout, 
      locknum2 => concat_02, 
      locknum3 => ua_preg22_dout, 
      locknum4 => ua_preg24_dout, 
      locknum5 => ua_preg25_dout, 
      locknum6 => unused_102, 
      fw1 => uf_fwul0_fw1, 
      fw2 => uf_fwul0_fw2, 
      fw3 => uf_fwul0_fw3, 
  ...
  UF_FWUL1 : fhm_fwu_lock_w32
    port map (
      ...
      data3 => ua_mux50_dout, 
      data4 => unused_104, 
      data5 => ua_preg66_dout, 
      data6 => concat_01, 
      data7 => ua_preg70_dout, 
      data8 => ua_preg23_dout, 
      num0 => ua_mux59_dout, 
      num1 => ua_mux60_dout, 
      num2 => unused_105, 
  ...
  UF_FWUL2 : fhm_fwu_lock_w32
    port map (
      ...
      data3 => ua_mux70_dout, 
      data4 => unused_109, 
      data5 => ua_preg86_dout, 
      data6 => concat_01, 
      data7 => ua_preg90_dout, 
      data8 => ua_preg23_dout, 
      num0 => ua_mux79_dout, 
      num1 => ua_mux80_dout, 
      num2 => unused_110, 
  ...
  UF_FWUL3 : fhm_fwu_lock_w32
    port map (
      ...
      data3 => ua_mux90_dout, 
      data4 => unused_114, 
      data5 => ua_preg106_dout, 
      data6 => concat_01, 
      data7 => ua_preg110_dout, 
      data8 => ua_preg23_dout, 
      num0 => concat_11, 
      num1 => ua_mux99_dout, 
      num2 => unused_115, 
      num3 => ua_preg114_dout, 
      num4 => unused_116, 
      num5 => ua_preg117_dout, 
      num6 => ua_preg25_dout, 
      num7 => ua_preg121_dout, 
      num8 => ua_preg26_dout, 
      locknum1 => ua_preg21_dout, 
      locknum2 => concat_02, 
      locknum3 => ua_preg22_dout, 
  ...
  bitrange4to1_00 <= ua_preg21_dout(4 downto 1);
  const_b1 <= '1';
  ...
  bitrange23to16_03 <= ua_preg09_dout(23 downto 16);
  bitrange15to8_03 <= ua_preg09_dout(15 downto 8);
  bitrange7to0_03 <= ua_preg09_dout(7 downto 0);
  ...
  bitrange31to24_03 <= ua_preg09_dout(31 downto 24);
  ...
  concat_09 <= bitrange31to24_03 & bitrange31to24_02 & bitrange23to16_02
  	& bitrange15to8_02;
  bitrange7to0_04 <= ua_preg10_dout(7 downto 0);
  bitrange15to8_04 <= ua_preg10_dout(15 downto 8);
  bitrange23to16_04 <= ua_preg10_dout(23 downto 16);
  bitrange31to24_04 <= ua_preg10_dout(31 downto 24);
  ...
  bitrange7to0_05 <= ua_preg15_dout(7 downto 0);
  bitrange15to8_05 <= ua_preg15_dout(15 downto 8);
  bitrange23to16_05 <= ua_preg15_dout(23 downto 16);
  bitrange31to24_05 <= ua_preg15_dout(31 downto 24);
  ...
  bitrange7to0_06 <= ua_preg20_dout(7 downto 0);
  bitrange15to8_06 <= ua_preg20_dout(15 downto 8);
  bitrange23to16_06 <= ua_preg20_dout(23 downto 16);
  bitrange31to24_06 <= ua_preg20_dout(31 downto 24);
  ...
  bitrange7to0_08 <= ua_preg19_dout(7 downto 0);
  bitrange15to8_07 <= ua_preg19_dout(15 downto 8);
  bitrange23to16_07 <= ua_preg19_dout(23 downto 16);
  bitrange31to24_07 <= ua_preg19_dout(31 downto 24);
  ...
  bitrange4to0_00 <= ua_preg27_dout(4 downto 0);
  bitrange4to0_01 <= ua_preg07_dout(4 downto 0);
  ...
  const_bv010 <= "010";
  concat_28 <= const_bv10 & const_bv100 & const_32h00000000 &
