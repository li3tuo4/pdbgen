...
// Generated by ASIP Meister 2.3 on 2014/09/16 16:01:20 
Design{
Version{"2.3"},
...
bit_width{"32"},
number_of_ports{"4"}}}
,"DATAOUT_FORMA"{class{"wire_out"},classpath{"/workdb/FHM_work/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"136"},
...
,"LWm"{variable{"wire[31:0] source0;
wire[31:0] source1;
wire[31:0] addr;
wire[31:0] bigE_word;
wire [31:0] tmp_pc;"},clk(1){"wire[31:0] current_pc;
...
null = [cond_m10]DATAOUT_FORMA.write(code_m10);"},
clk(5){"null = FWUL0.forward5(rt,bigE_word);
null = FWUL1.forward5(rt,bigE_word);
null = FWUL2.forward5(rt,bigE_word);
null = FWUL3.forward5(rt,bigE_word);"},
