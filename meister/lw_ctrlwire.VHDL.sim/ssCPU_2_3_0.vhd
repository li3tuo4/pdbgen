...
architecture RTL of ssCPU_2_3_0 is
  ...
  signal concat_28 : std_logic_vector(135 downto 0);
  ...
  signal ua_preg62_dout : std_logic_vector(4 downto 0);
  signal ua_preg63_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_preg71_dout : std_logic_vector(31 downto 0);
  signal ua_preg72_dout : std_logic_vector(31 downto 0);
  signal ua_preg73_dout : std_logic_vector(31 downto 0);
  ...
  signal ua_preg82_dout : std_logic_vector(4 downto 0);
  signal ua_preg83_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_preg91_dout : std_logic_vector(31 downto 0);
  signal ua_preg92_dout : std_logic_vector(31 downto 0);
  signal ua_preg93_dout : std_logic_vector(31 downto 0);
  ...
  signal ua_preg102_dout : std_logic_vector(4 downto 0);
  signal ua_preg103_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_preg111_dout : std_logic_vector(31 downto 0);
  signal ua_preg112_dout : std_logic_vector(31 downto 0);
  signal ua_preg113_dout : std_logic_vector(31 downto 0);
  ...
  signal ua_preg122_dout : std_logic_vector(4 downto 0);
  signal ua_preg123_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_preg61_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_preg81_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_preg101_dout : std_logic_vector(4 downto 0);
  ...
  signal ua_preg121_dout : std_logic_vector(4 downto 0);
  ...
  signal uf_dataout_forma_wmode : std_logic;
...
begin
  ...
  UF_GPR : fhm_registerfile_w32
    port map (
      ...
      w_sel0 => ua_preg33_dout, 
      w_sel1 => ua_preg27_dout, 
      data_in0 => ua_preg36_dout, 
      data_in1 => ua_preg24_dout, 
  ...
  UF_FWUL0 : fhm_fwu_lock_w32
    port map (
      ...
      data3 => ua_mux30_dout, 
      data4 => unused_99, 
      data5 => ua_preg47_dout, 
      data6 => concat_01, 
      data7 => ua_preg51_dout, 
      data8 => ua_preg24_dout, 
      num0 => ua_mux39_dout, 
      num1 => ua_mux40_dout, 
      num2 => unused_100, 
      num3 => ua_preg55_dout, 
      ...
      num7 => ua_preg62_dout, 
      num8 => ua_preg27_dout, 
      locknum1 => ua_preg22_dout, 
      locknum2 => concat_02, 
      locknum3 => ua_preg23_dout, 
      locknum4 => ua_preg25_dout, 
      locknum5 => ua_preg26_dout, 
      locknum6 => unused_102, 
      fw1 => uf_fwul0_fw1, 
      fw2 => uf_fwul0_fw2, 
      fw3 => uf_fwul0_fw3, 
  ...
  UF_FWUL1 : fhm_fwu_lock_w32
    port map (
      ...
      data3 => ua_mux50_dout, 
      data4 => unused_104, 
      data5 => ua_preg67_dout, 
      data6 => concat_01, 
      data7 => ua_preg71_dout, 
      data8 => ua_preg24_dout, 
      num0 => ua_mux59_dout, 
      num1 => ua_mux60_dout, 
      num2 => unused_105, 
  ...
  UF_FWUL2 : fhm_fwu_lock_w32
    port map (
      ...
      data3 => ua_mux70_dout, 
      data4 => unused_109, 
      data5 => ua_preg87_dout, 
      data6 => concat_01, 
      data7 => ua_preg91_dout, 
      data8 => ua_preg24_dout, 
      num0 => ua_mux79_dout, 
      num1 => ua_mux80_dout, 
      num2 => unused_110, 
  ...
  UF_FWUL3 : fhm_fwu_lock_w32
    port map (
      ...
      data3 => ua_mux90_dout, 
      data4 => unused_114, 
      data5 => ua_preg107_dout, 
      data6 => concat_01, 
      data7 => ua_preg111_dout, 
      data8 => ua_preg24_dout, 
      num0 => concat_11, 
      num1 => ua_mux99_dout, 
      num2 => unused_115, 
      num3 => ua_preg115_dout, 
      num4 => unused_116, 
      num5 => ua_preg118_dout, 
      num6 => ua_preg26_dout, 
      num7 => ua_preg122_dout, 
      num8 => ua_preg27_dout, 
      locknum1 => ua_preg22_dout, 
      locknum2 => concat_02, 
      locknum3 => ua_preg23_dout, 
  ...
  UF_DATAOUT_FORMA : fhm_wire_out_w136
    port map (
      int_port => concat_28, 
      ext_port => unused_118, 
      wmode => uf_dataout_forma_wmode
    );
  ...
  UA_CTRL : rtg_controller
    port map (
      ...
      DATAOUT_SAVED_PC => unused_121, 
      DATAOUT_DS_OFFSET => unused_122, 
      ...
      CTRLOUT_DATAOUT_FORMA_WMODE => uf_dataout_forma_wmode, 
  ...
  bitrange4to1_00 <= ua_preg22_dout(4 downto 1);
  const_b1 <= '1';
  ...
  bitrange23to16_03 <= ua_preg10_dout(23 downto 16);
  bitrange15to8_03 <= ua_preg10_dout(15 downto 8);
  bitrange7to0_03 <= ua_preg10_dout(7 downto 0);
  ...
  bitrange31to24_03 <= ua_preg10_dout(31 downto 24);
  ...
  concat_09 <= bitrange31to24_03 & bitrange31to24_02 & bitrange23to16_02
  	& bitrange15to8_02;
  bitrange7to0_04 <= ua_preg11_dout(7 downto 0);
  bitrange15to8_04 <= ua_preg11_dout(15 downto 8);
  bitrange23to16_04 <= ua_preg11_dout(23 downto 16);
  bitrange31to24_04 <= ua_preg11_dout(31 downto 24);
  ...
  bitrange7to0_05 <= ua_preg16_dout(7 downto 0);
  bitrange15to8_05 <= ua_preg16_dout(15 downto 8);
  bitrange23to16_05 <= ua_preg16_dout(23 downto 16);
  bitrange31to24_05 <= ua_preg16_dout(31 downto 24);
  ...
  bitrange7to0_06 <= ua_preg21_dout(7 downto 0);
  bitrange15to8_06 <= ua_preg21_dout(15 downto 8);
  bitrange23to16_06 <= ua_preg21_dout(23 downto 16);
  bitrange31to24_06 <= ua_preg21_dout(31 downto 24);
  ...
  bitrange7to0_08 <= ua_preg20_dout(7 downto 0);
  bitrange15to8_07 <= ua_preg20_dout(15 downto 8);
  bitrange23to16_07 <= ua_preg20_dout(23 downto 16);
  bitrange31to24_07 <= ua_preg20_dout(31 downto 24);
  ...
  bitrange4to0_00 <= ua_preg28_dout(4 downto 0);
  bitrange4to0_01 <= ua_preg08_dout(4 downto 0);
  ...
  const_bv011 <= "011";
  concat_28 <= const_bv10 & const_bv001 & const_32h00000000 &
