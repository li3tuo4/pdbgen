...
-- Generated by ASIP Meister 2.3 on 2014/09/19 19:06:42 
----------------------------------------------------------------------

-----------------------------------------------------------
-- Entity Name: rtg_register_w381
-----------------------------------------------------------

library IEEE;
use IEEE.std_logic_1164.all;

entity rtg_register_w381 is
  port (
    CLK : in std_logic;
    RST : in std_logic;
    ENB : in std_logic;
    DIN : in std_logic_vector(380 downto 0);
    DOUT : out std_logic_vector(380 downto 0)
  );
end entity rtg_register_w381;

architecture RTL of rtg_register_w381 is
