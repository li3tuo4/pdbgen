...
-----------------------------------------------------------
-- Entity Name: rtg_register_w246
-----------------------------------------------------------

library IEEE;
use IEEE.std_logic_1164.all;

entity rtg_register_w246 is
  port (
    CLK : in std_logic;
    RST : in std_logic;
    ENB : in std_logic;
    DIN : in std_logic_vector(245 downto 0);
    DOUT : out std_logic_vector(245 downto 0)
  );
end entity rtg_register_w246;

architecture RTL of rtg_register_w246 is
